-- Migration: 008_update_search_profiles_rpc
-- Description: Update search_profiles RPC to include new profile fields and filter by approved status

-- Update search_profiles function to include new fields and filter by approved status
...
-- Update search_profiles_count function to filter by approved status
