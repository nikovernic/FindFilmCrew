-- Migration: 016_fix_role_search_case_sensitivity
-- Description: Fix case-sensitivity bug in role search where the ELSE branch
-- overwrites the lowered normalized_role with the original-case filter_role,
-- causing LIKE comparisons against LOWER(primary_role) to fail.
